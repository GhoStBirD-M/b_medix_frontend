...
import 'package:test_c/main.dart';
...
class PillReminderController extends GetxController {
  ...
  const androidDetails = AndroidNotificationDetails(
    ...
    enableLights: true,
    playSound: true,
    timeoutAfter: 60000,  // Optional timeout value in ms
    ongoing: false,  // Optional: set to true if you want the notification to be ongoing
  );
  ...
  await flutterLocalNotificationsPlugin.zonedSchedule(
    ...
    notificationDetails,
    androidScheduleMode: AndroidScheduleMode.exactAllowWhileIdle, // Ensure exact scheduling even if idle
    matchDateTimeComponents: DateTimeComponents.time, // For daily reminder
  );
}
